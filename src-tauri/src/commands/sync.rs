...
// passes the hq-pro min-version gate. Tightening the tilde floor to ~6.11.6
// guarantees a fresh install (or an npx cache that pinned an older 6.11.x)
// resolves a compliant runner, not just the latest-by-luck.
