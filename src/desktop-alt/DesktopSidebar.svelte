<script lang="ts">
  ...
  // Top-level destinations (Sync / Meetings / Library / Messages / admin-only
  // Moderation) vs. per-company rows. Split on route kind so optional primary
  // rows (e.g. Moderation) can't shift a fixed-index slice and leak a company
